...
export const DEMOS = [
  ...
  { house: 2, Y: [0, 0, 2, 0, 1, 0, 0], L: [2, 0, 0, 0, 0, 0, 0], outcome: 'capture', relays: 1,
    caption: 'Y2\'s last shell lands in Y4, which has a shell: pick both up and keep sowing (relay). It ends in your empty Y6, so you capture Lola\'s 2 opposite, plus that shell, and the turn ends.' },
